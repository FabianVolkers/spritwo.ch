...
existing_events = load_existing_events('.github/workflows/calendar_events.json')
...
save_updated_events('.github/workflows/calendar_events.json', existing_events, new_events)
